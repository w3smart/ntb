...
<html>
    ...
    <body>
        <div class="container">
            ...
            <form name="formLands" id="formLands" method="post">
                <div class="row">
                    <div class="span12">
                        Location
                        ...
                        <table class="table table-bordered table-striped table-condensed table-hover">
                            ...
                            <tbody> 
                                <c:forEach var="land" items="${atomicBean.listLand}">
                                    <tr>
                                        <td>
                                            <p><a href="land.jsp?action=edit&id=${land.id}">${land.name}</a></p>
                                        </td>
                                        <td>
                                            <jsp:setProperty name="locationBean" property="id" value="${land.address}" />
                                        ...
                                        <td>
                                            <a class="btn btn-small" role="button" href="land.jsp?action=edit&id=${land.id}"><i class="icon icon-pencil"></i> Edit</a>
                                            <a class="btn btn-danger btn-small" href="../con?control=deleteLand&id=${land.id}"><i class="icon icon-trash"></i> Remove</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                            </tbody>
